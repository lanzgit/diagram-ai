...
class ChatGPTAPI: @unchecked Sendable {
    ...
    //TODO: implementar depois as datas nas mensagens
    ...
    init(apiKey: String, model: String = "gpt-3.5-turbo", systemPrompt: String = "Ure a good assistant", temperature: Double = 0.5) {
        self.apiKey = apiKey
        self.model = model
